            ...
            <div class="col-md-9 col-12">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="5" name="description" id="description"
                  style="border-radius: 10px; height: 500px"><?= $description ?></textarea>
              </div>

              <button class="btn btn-success" style="margin-left: 550px; margin-top: 20px">Save</button>
            </div>
            <div class="col-md-3 col-12"
              style=" border: solid grey 1px; padding-top: 10px; padding-bottom: 10px; border-radius: 15px">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required="true" type="text" class="form-control" id="publisher" name="publisher"
                  value="<?= $publisher ?>">
              </div>
              <div class="form-group">
                <label for="publish_year">Publish year:</label>
                <input required="true" type="text" class="form-control" id="publish_year" name="publish_year"
                  value="<?= $publish_year ?>">
              </div>
              <div class="form-group">
                <label for="total_page">Total page:</label>
                <input required="true" type="text" class="form-control" id="total_page" name="total_page"
                  value="<?= $total_page ?>">
              </div>
              <div class="form-group">
